...
const Amenities = () => {
  ...
  useEffect(() => {
    // ১. Our Services Section Animation (Fade in + Staggered slide up)
    ...
    // ২. Facilities BG Section (Left Text fade-in, right cards scaling)
    const facilityText = facilitiesGridRef.current.querySelector('.facility-text');
    const facilityCards = facilitiesGridRef.current.querySelectorAll('.facility-card');
    
    gsap.fromTo(facilityText,
      { opacity: 0, x: -50 },
      {
        opacity: 1,
        x: 0,
        ...
        ease: 'power2.out',
        scrollTrigger: {
          trigger: facilitiesGridRef.current,
          start: 'top 75%'
        }
      }
    );
    ...
    // ৩. ১২টি আইটেমের গ্রিড সেকশন অ্যানিমেশন
    const gridItems = topGridRef.current.querySelectorAll('.grid-item');
    ...
    // ৪. কাউন্টার/স্ট্যাটস সেকশন অ্যানিমেশন (Numbers Counting Effect)
    const statsItems = statsRef.current.querySelectorAll('.stat-box');
    ...
    // ৬. Feedback Form Section Animation
    const leftContact = feedbackRef.current.querySelector('.contact-left');
    const rightForm = feedbackRef.current.querySelector('.form-right');
  ...
  return (
    <div className="w-full font-sans antialiased text-gray-800">
      ...
      {/* সেকশন ১: Our Services */}
      <section ref={servicesRef} className="max-w-[1440px] mx-auto px-4 py-16">
      ...
      >
        ...
        <div className="relative max-w-[1440px] mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="facility-text text-white text-center lg:text-left">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 w-full mt-4 justify-center lg:justify-start">
              <div className="facility-card bg-white flex flex-col items-center w-[280px] h-[200px] justify-center text-center shadow-lg">
      ...
      {/* সেকশন ৩: ১২টি আইটেম গ্রিড */}
      <div ref={topGridRef} className="w-full bg-white font-sans py-10">
      ...
      {/* সেকশন ৪: ৩ কলাম বিশিষ্ট Facilities সেকশন */}
      <div ref={roomsRef} className="w-full bg-white font-sans py-16">
        <div className="max-w-[1440px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-16">
            {/* ১. Smoking Free */}
            <div className="room-card flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">Smoking Free</h3>
            ...
            <div className="room-card flex gap-4 items-start">
             <img src="https://neeshorgo.com.bd/wp-content/uploads/2017/07/icon-14-1.png" alt="Cash" className="w-10 h-10 mb-2 object-contain opacity-70" />
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">Swimming Pool</h3>
                <p className="text-[18px] text-gray-400 leading-relaxed font-light text-justify">
                  It's hard to find a bad view in Neeshorgo. But you can kick things up a notch with the roof top Infinity pool at the Neeshorgo Hotel & Resort. It overlooks the Mountain View on the East Side and Sea side view on the West.
                </p>
              </div>
            ...
            <div className="room-card flex gap-4 items-start">
             <img src="https://neeshorgo.com.bd/wp-content/uploads/2017/07/icon-15.png" alt="Cash" className="w-10 h-10 mb-2 object-contain opacity-70" />
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">Laundry Service</h3>
                <p className="text-[18px] text-gray-400 leading-relaxed font-light text-justify">
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">Welcome Drink</h3>
                <p className="text-[18px] text-gray-400 leading-relaxed font-light text-justify">
            ...
            <div className="room-card flex gap-4 items-start">
             <img src="https://neeshorgo.com.bd/wp-content/uploads/2017/07/icon-12.png" alt="Cash" className="w-10 h-10 mb-2 object-contain opacity-70" />
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">King Beds</h3>
                <p className="text-[18px] text-gray-400 leading-relaxed font-light text-justify">
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-3 tracking-wide">Airport Shuttle</h3>
                <p className="text-[18px] text-gray-400 leading-relaxed font-light text-justify">
      ...
      {/* সেকশন ৫: কাউন্টার বা স্ট্যাটস সেকশন */}
      <div 
        ref={statsRef}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full text-white py-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-3xl">
            ...
            <div className="stat-box flex flex-col">
              <span className="stat-number text-4xl md:text-5xl font-light tracking-wide mb-1">15</span>
              <span className="text-[10px] md:text-xs text-gray-300 uppercase tracking-[0.15em] font-medium">Suites</span>
            </div>

            {/* ২. Rooms */}
            <div className="stat-box flex flex-col">
              <span className="stat-number text-4xl md:text-5xl font-light tracking-wide mb-1">100</span>
              <span className="text-[10px] md:text-xs text-gray-300 uppercase tracking-[0.15em] font-medium">Rooms</span>
            </div>

            {/* ৩. Staff */}
            <div className="stat-box flex flex-col">
              <span className="stat-number text-4xl md:text-5xl font-light tracking-wide mb-1">47</span>
              <span className="text-[10px] md:text-xs text-gray-300 uppercase tracking-[0.15em] font-medium">Staff</span>
            </div>

            {/* ৪. Services */}
            <div className="stat-box flex flex-col">
              <span className="stat-number text-4xl md:text-5xl font-light tracking-wide mb-1">10</span>
              <span className="text-[10px] md:text-xs text-gray-300 uppercase tracking-[0.15em] font-medium">Services</span>
            </div>
          </div>
        </div>
      </div>

      {/* সেকশন ৬: Best Rooms List */}
      <div className="w-full bg-white font-sans py-16">
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-medium block mb-1">Check Our</span>
            <div className="w-8 h-[1px] bg-gray-400 mx-auto mb-4"></div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 tracking-wide">Best Rooms</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div className="w-full">
                ...
                <p className="text-xs text-gray-400 leading-relaxed font-light">The Standard Guest Suite includes 32" LED Flat Screen TV's, Free high speed wireless internet access</p>
              </div>
            </div>
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div className="w-full">
                ...
                <p className="text-xs text-gray-400 leading-relaxed font-light">Gracefully decorated one-bedroom suites offer one king-sized bed and a separate living space.</p>
              </div>
            </div>
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div className="w-full">
                ...
                <p className="text-xs text-gray-400 leading-relaxed font-light">Spacious, stylish and thoughtfully designed, Suites are the crown jewels of Neeshorgo, with two large, high-ceilinged bedrooms.</p>
              </div>
            </div>
            ...
            <div className="room-card flex gap-4 items-start">
              ...
              <div className="w-full">
                ...
                <p className="text-xs text-gray-400 leading-relaxed font-light">With fresh, seaside-chic interiors and their own beachfront views</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div 
        ...
        style={{ backgroundImage: "url('https://images.pexels.com/photos/11788437/pexels-photo-11788437.jpeg')" }}
      >
        ...
        <div className="relative z-10 bg-white w-full max-w-4xl p-8 md:p-12 shadow-lg grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div className="contact-left">
            <span className="inline-block bg-black text-white text-[10px] uppercase tracking-widest px-3 py-1 font-medium mb-3">Contact Us</span>
            <h2 className="text-2xl font-normal text-gray-800 mb-8 tracking-wide">Leave your Feedback</h2>

            <div className="space-y-4 text-xs text-gray-500">
              <div className="flex justify-between items-start border-b border-gray-100 pb-2">
                <span className="font-medium text-gray-700">Address :</span>
                <span className="text-right max-w-[180px] leading-relaxed">Plot No. 492, Marine Drive Road</span>
              </div>
          ...
          {/* ডান পাশ */}
          <form className="form-right flex flex-col space-y-4 text-xs">
            <div className="flex flex-col space-y-1">
              <label className="text-gray-600 font-medium">Name :</label>
              <input type="text" className="w-full bg-gray-50 border border-gray-200 p-2 focus:outline-none focus:border-gray-400" />
            </div>
            <div className="flex flex-col space-y-1">
              <label className="text-gray-600 font-medium">Email :</label>
              <input type="email" className="w-full bg-gray-50 border border-gray-200 p-2 focus:outline-none focus:border-gray-400" />
            </div>
            <div className="flex flex-col space-y-1">
              <label className="text-gray-600 font-medium">Message :</label>
              <textarea rows="5" className="w-full bg-gray-50 border border-gray-200 p-2 resize-none focus:outline-none focus:border-gray-400"></textarea>
            </div>
            <button type="submit" className="bg-black text-white py-2.5 px-4 font-medium uppercase tracking-wider hover:bg-gray-800 transition-colors self-start mt-2">
              Submit
            </button>
          </form>
        </div>
